      ...
      <div class="container-fluid">
        <div class="row">
                  ...
                  <tbody>
                    @foreach ($goods as $item)
                      <tr>
                        ...
                        <td>{{ $item->qty_buffer }}</td>
                        <td>{{ $item->qty_onorder }}</td>
                        <td>
          ...
          <div class="col-md-6">
                  ...
                  <tbody>
                    @foreach ($poreqdet as $item_req)
                      <tr>
                        ...
                        <td>{{ $item_req->unit }}</td>
                        <td>
                          <a wire:click="edit_qty_prdet({{ $item_req }})" class="btn btn-primary btn-xs" data-bs-toggle="modal" data-bs-target="#Modal1">Edit</a>
            ...
            <div class="col-sm-10">
            <button type="button" class="btn btn-primary" wire:click="process_po()">Process</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" wire:click="upd_qty_prdet({{ $id }}, {{ $qty_req }})" data-bs-dismiss="modal">Ya</button>
      </div>
    </div>
  </div>
</div>
