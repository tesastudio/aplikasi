...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-6">
          <div class="col-sm-6">
            <h1>{{ $header_title }} (Total: {{ $depts->count() }})</h1>
          </div>
          <div>
                  ...
                  <tbody>
                    @foreach ($depts as $dept)
                      <tr>
                        ...
                        <td><a href="{{ url('admin/admin/edit/'.$dept->id ) }}" class="btn btn-primary">Edit</a> 
                          <a href="{{ url('admin/admin/delete/'.$dept->id) }}" class="btn btn-danger">Delete</a>
                        </td>
                      </tr>
                    @endforeach
